function NavbarPage() {
    return (
        <div className="min-h-screen bg-gradient-to-r from-purple-900 via-blue-900 to-cyan-700">

            {/* Navbar */}
            <nav className="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
                        <img src="https://media.licdn.com/dms/image/v2/D5605AQEHe4abfxS7xg/videocover-high/B56Ziu39m5G0CI-/0/1755280804622?e=2147483647&v=beta&t=CIXOfYbXNnIT5VS4-T17kUV9uI7pRtGJcdfwnvI-Cx4" className="h-8" alt="Flowbite Logo" />
            ...
            <section className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto py-16 px-6">
                ...
                <div className="md:w-1/2 text-white space-y-6">
                    ...
                    <p className="text-gray-300 text-lg">
                        Employee management is the process by which employers ensure workers
                        perform their jobs to the best of their abilities so as to achieve
                        business goals. It typically entails building and maintaining
                        healthy relationships with employees, as well as monitoring their
                        daily labor and measuring progress. In this way, employers can
                        identify opportunities for improvement and recognize achievements.
                    </p>
                ...
                <div className="mt-10 md:mt-0 md:w-1/2 flex justify-center">
                    <div className="max-w-md bg-white rounded-xl shadow-lg p-5">
                        ...
                        <img src="https://intel-cs.com/wp-content/uploads/2024/09/servizio-azienda-consulenza.jpg" alt="Case Study" className="rounded-lg" />
                    </div>
                </div>
            </section>
        </div>
